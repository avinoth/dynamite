...
class DebtsControllerTest < ActionController::TestCase
  ...
  test "should create debt" do
    assert_difference('Debt.count') do
      post :create, debt: { by: @debt.by, date: @debt.date, description: @debt.description, owe: @debt.owe }
    end
  ...
  test "should update debt" do
    patch :update, id: @debt, debt: { by: @debt.by, date: @debt.date, description: @debt.description, owe: @debt.owe }
    assert_redirected_to debt_path(assigns(:debt))
  end
